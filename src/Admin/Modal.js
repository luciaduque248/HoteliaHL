                    ...
                    <form onSubmit={handleEdit} className='formulario-modal'>
                        <div className='colummns-edit'>
                            ...
                            <div className='column-1'>
                                ...
                                <div className='lines-room-edit'>
                                    <div className='flex-form-edit  number-inputs'>
                                        <label>Cap. de Personas:</label>
                                        <input value={room.capacidad} onChange={handleValues} name='capacidad' id='capacidad' type='number' />
                                    </div>
                                    <div className='flex-form-edit precio-edit number-inputs'>
                                        <label>Precio:</label>
                            ...
                            <div className='column-2'>
                                ...
                                <div className='lines-room-edit flex-form-edit'>
                                    <label>Estado:</label>
                                ...
                                <div className='lines-room-edit'>
                                    <div className='flex-form-edit observaciones-edit'>
                                        ...
                                        <div className='flex-si-no-edit'>
                                            <div className='lines-selector-edit'>
